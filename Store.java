...
public class Store {
    ...
    public static int[] buttonID = {Value.airFence, Value.airAir, Value.airAir,Value.airAir,Value.airAir,Value.airAir,Value.airAir,Value.airTrashCan };
    public static int[] buttonPrice = {40, 0, 0, 0, 0, 0, 0, 0};
